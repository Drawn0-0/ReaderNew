...
public class CardRecycleViewHistory extends RecyclerView.Adapter<CardRecycleViewHistory.VH> {
    private final Context context;
    private List<history> bean;
    ...
    public CardRecycleViewHistory(Context context, List<history> bean) {
