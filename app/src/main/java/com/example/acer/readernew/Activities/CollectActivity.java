...
public class CollectActivity extends AppCompatActivity {
    ...
    private CardRecycleViewCollect adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(R.string.nav_collection);
        }
        initView();
        initData();
        initEvent();
    ...
    private void initEvent() {
        adapter.setOnClickListener(new RecycleViewOnClickListener() {
            ...
            public void OnItemClick(View view, int position) {
                Collection itemData = adapter.getItemData(position);
                ...
                ActivityOptionsCompat transitionActivityOptions = ActivityOptionsCompat.makeSceneTransitionAnimation(CollectActivity.this, pairImg);
            ...
            public void OnLongClick(View v, final int position) {
                ...
                builder.setPositiveButton(R.string.dialog_alert_yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        BaseApplication.getDaoSession().getCollectionDao().delete(adapter.getItemData(position));
    ...
    private void initData() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                List<Collection> tempList = DaoUtil.getAllCollect();
    ...
    private void initView() {
        ...
        adapter = new CardRecycleViewCollect(this, collections);
